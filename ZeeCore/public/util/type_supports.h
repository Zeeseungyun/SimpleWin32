...
#include <type_traits>
#include <utility>
#include "../math/vec/vec_decl_new.h"
...
//	//Forward declaration
//namespace math {
//	template<size_t/*CompSize*/, typename/*VecElemT*/> struct vec_impl;
//}//namespace zee::math
//
//namespace impl {
//	template<typename T>
...
//	struct is_vec_impl<math::vec_impl<CompSize, VecElemT>> {
//	private:
//		typedef char yes[2];
//		typedef char no[1];
//
...
//	struct is_vec_with_size_impl<CompSize, math::vec_impl<VecCompSize, VecElemT>> {
//		static constexpr bool value = false;
//	};
//
//	template<size_t VecCompSize, typename VecElemT>
//	struct is_vec_with_size_impl<VecCompSize, math::vec_impl<VecCompSize, VecElemT>> {
//		static constexpr bool value = is_vec_impl<math::vec_impl<VecCompSize, VecElemT>>::value;
//	};
//
//	template<typename... Args>
...
//	struct vec_promoition <math::vec_impl<CompSize, VecElem1T>> {
//		typedef math::vec_impl<CompSize, VecElem1T> type;
//		typedef VecElem1T elem_type;
//	};
//
//	template<size_t CompSize, typename VecElem1T, typename... Args>
//	struct vec_promoition <math::vec_impl<CompSize, VecElem1T>, Args...>  {
//		typedef typename vec_promoition<Args...>::elem_type inner_elem_type;
//		typedef promotion_t<VecElem1T, inner_elem_type> elem_type;
//		typedef math::vec_impl<CompSize, promotion_t<VecElem1T, inner_elem_type>> type;
//	};
//
//}//namespace zee::impl
