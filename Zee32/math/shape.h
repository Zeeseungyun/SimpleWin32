...
namespace impl {
	...
	template<typename ElemT>
	struct size2_base<ElemT>::constants {
		static constexpr size2_base<ElemT> zero = {};
	};
	...
	template<typename ElemT>
	struct rect_base<ElemT>::constants {
		static constexpr rect_base<ElemT> zero = { 0, 0, 0, 0 };
	};
	...
	template<typename ElemT>
	struct circle_base<ElemT>::constants {
		static constexpr circle_base<ElemT> zero = {};
	};
