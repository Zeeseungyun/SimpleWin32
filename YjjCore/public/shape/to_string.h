...
namespace impl {
	...
	constexpr const char* to_string(collide_type v) noexcept {
		switch (v)
		{
		case yjj::shape::collide_type::intersect: return "intersect"; break;
		case yjj::shape::collide_type::contain: return "contain"; break;
		case yjj::shape::collide_type::none: 
		default:
			break;
		}
	...
	constexpr const wchar_t* to_wstring(collide_type v) noexcept {
		switch (v)
		{
		case yjj::shape::collide_type::intersect: return L"intersect"; break;
		case yjj::shape::collide_type::contain: return L"contain"; break;
		case yjj::shape::collide_type::none:
		default:
			break;
		}
