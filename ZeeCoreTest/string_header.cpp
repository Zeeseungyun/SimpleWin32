...
int string_header_test() {
    ...
    zee::strmanip_base<char>::sprintf(temp, ", asdf%d", 123123);
    zee::strmanip_base<char>::cur_time_to_str(temp, "%Y%m");
    int asdfasdf = 0;
    std::cout << zee::strmanip_base<char>::cur_time_to_str("%Y") << std::endl;
    std::cout << temp << std::endl;

    std::wstring temp2 = L"asdf1";
    zee::strmanip_base<wchar_t>::sprintf(temp2, L", asdf%d", 123123);
    zee::strmanip_base<wchar_t>::cur_time_to_str(temp2, L"%Y%m");
    std::wcout << zee::strmanip_base<wchar_t>::cur_time_to_str(L"%Y") <<std::endl;
