...
#include <chrono>
            namespace zee {
                ...
                private:
                    ...
                    T impl() const {
                        return duration_cast<std::chrono::duration<T, PriodT>>(clock_type::now() - started).count();
                    }
                ...
                private:
                    std::chrono::time_point<clock_type> started;
                };
            }
...
int main()
{
    ...
    std::cout << ss.nano_sec() << std::endl;
    std::cout << ss.mili_sec() << std::endl;
    std::cout << ss.sec() << std::endl;
    std::cout << ss.min<float>() << std::endl;
