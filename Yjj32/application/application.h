...
namespace yjj {
	...
	public:
		const yjj::basic_config<config_data>& app_config() const noexcept { return yjj::basic_config<config_data>::get(); }
		const config_data& config() const noexcept { return app_config().data(); }

	protected:
		yjj::basic_config<config_data>& app_config_() noexcept { return yjj::basic_config<config_data>::get(); }
...
template<>
struct nlohmann::adl_serializer<yjj::application::config_data> {
	typedef yjj::application::config_data data_type;
