...
namespace yjj {
	...
	private:
		...
		enum const_var_ {
			...
			destroy_bullet_monster_zone,
			destroy_bullet_player_zone,

			player_bullet_max_num = 20,
			monster_bullet_max_num = 60,
		};
		const std::vector<math::vec2i> coords_bullet_{
			...
			{2400, 2400},	//destroy_bullet_player_zone
			{2600, 2600},	//destroy_bullet_monster_zone
		};
